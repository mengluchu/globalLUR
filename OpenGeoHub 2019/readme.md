The ** Geohub.Rmd ** file is the main script for the workshop. The ** plot_RS.Rmd ** shows the 3 remote sensing products use. The course materials contain the following folder:
