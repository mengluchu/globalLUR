...
packages <- c( "raster", "dplyr",  "rgdal","Matrix","xgboost"  )
ipak(packages)
...
source("E:/OpenGeoHub 2019/tiles/GlobalLUR_R/merge_roads.R")
load("E:/OpenGeoHub 2019/tiles/data/mergedu.Rdata")
...
# reorder the dataframe
    pre_mat3 %>%dplyr::select (names(s1)) -> pre_mat3
