...
Fill missing data with NA. Merge roads of road type 3, 4, 5, the road length of these road types are aggregated. The original road types are substituted (with keep =T, they are remained). 
...
```{r XGBOOST}
  ...
  nthread = 2
  nrounds = 1000
  bst <- xgboost(data = dfmatrix, label = y_train, max_depth = max_depth, eta = eta, nthread = nthread, nrounds = nrounds, verbose = 0)
